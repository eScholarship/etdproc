...
class configDb:
    #allSqlFiles = ["campuses.sql","packages.sql","actionlog.sql","errorlog.sql","settings.sql","identifiers.sql","merrittcallback.sql","merrittrequest.sql","escholrequest.sql"]
    allSqlFiles = ["queues.sql"]
    sqlpath = 'sqlscripts/'
